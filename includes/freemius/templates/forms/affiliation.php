                    ...
                    <div class="inside">
                        ...
                        <div class="entry-content">
                                ...
                                <form>
									...
									<?php if ( ! $is_affiliate ) : ?>
                                        <div>
                                            ...
                                            <label for="legal_consent_checkbox">I agree to the <a
                                                        href="<?php echo $affiliate_program_terms_url ?>"
                                                        target="_blank" rel="noopener">Referrer Program</a>'s terms &
                                                conditions.</label>
                                        </div>
									<?php endif ?>
                                </form>
							...
							<?php if ( ! $is_affiliate ) : ?>
                                ...
                                <a id="submit_button" class="button button-primary disabled" href="#"
