...
<?php if ( $is_not_paying ) : ?>
    <strong><a href="<?php echo esc_attr( $upgrade_link )?>">This feature is only availbale in the Pro version of Protect Content PRO. Click to upgrade and access all pro feaures.</a></strong>
<?php endif; ?>


<p class="protect-content-pro-form-notification"><i><span class="dashicons dashicons-info-outline"></span> This
        blocks the rest api to non-logged in users, preventing programmtic access to your site's content</i></p>